...
import { Exporter, ExporterBuffer, ExporterConfig, Span, SpanKind, RootSpan } from '@opencensus/core';
...
export class ZipkinTraceExporter implements Exporter {
  ...
  translateSpan(span: Span): TranslatedSpan {
    const spanTraslated = {
      ...
      localEndpoint: { serviceName: this.serviceName, ipv4: address.ip('eth') },
